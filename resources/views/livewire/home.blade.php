    ...
    <div class="card-header d-flex justify-content-between">
        ...
        <div class="text-center ms-3 ms-lg-0 ms-md-0">
            <a href="#" class="mt-lg-0 mt-md-0 mt-3 btn btn-primary btn-icon" data-bs-toggle="tooltip"
                data-modal-form="form" data-icon="person_add" data-size="small" data--href="{{ route('home') }}"
                data-app-title="Add new permission" data-placement="top" title="New Permission">
                <i class="btn-inner">
